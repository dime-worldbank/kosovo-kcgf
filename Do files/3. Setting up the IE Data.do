	...
	*----------------------------------------------------------------------------------------------------------------------------------------->>
	{			
				...
				*------------------------------------------------------------------------------------------------------------------------------>>
				...
				su	     number_loans_up2015						if period == 2015, detail
				replace  number_loans_up2015 = . 					if period == 2015 & number_loans_up2015 > r(p95)
				...
				sort 	fuid period
				br 		fuid period active *num_loans* had_loan_up2015 if period == 2015
				...
				*------------------------------------------------------------------------------------------------------------------------------>>
				cap noi quantiles productivity_r if period == 2015 & active == 1 & sme == "a.1-9" ,  n(10) gencatvar(qua_productivity_r)
				cap noi quantiles turnover_r 	 if period == 2015 & active == 1 & sme == "a.1-9" ,  n(10) gencatvar(qua_turnover_r)
				...
				**
				...
				foreach var of varlist productivity_r turnover_r employees {
					gen l_`var' = ln(`var')
